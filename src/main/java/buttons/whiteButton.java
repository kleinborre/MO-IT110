...
public class whiteButton extends JButton {
    ...
    public whiteButton() {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                hover = true;
                setForeground(new Color(60, 60, 60)); // Slightly darker font on hover
                repaint();
            }
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        if (hover) {
            ...
            g2.setColor(new Color(227, 229, 230, 150)); // #e3e5e6 with 150 alpha
        } else {
            // Normal button color
            g2.setColor(new Color(227, 229, 230)); // #e3e5e6
        }
